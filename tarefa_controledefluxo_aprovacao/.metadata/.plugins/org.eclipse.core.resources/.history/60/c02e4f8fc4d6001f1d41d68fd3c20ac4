...
public class MediaDeNotas { //declara uma classe pública-->'MediaNotas
	public static void main(String[] args) {//esse é o met principal, ponto de entrada do programa: é o método que o Java executa quando o prog é rodado
		...
		float med = mostrarnotas(n1, n2, n3, n4);	
	...
	public static float mostrarnotas(int n1, int n2, int n3, int n4) {//esse é o método para mostrar as notas e calcular a média
		System.out.printf("A primeira nota é:" + n1 + "\n");
	...
	public static void aprovacao(float med) {
		if (med >=7) {
			System.out.println("Você foi aprovado! Parabéns!!"); 
		} else if (med >=5) {
			System.out.println("Você está de recuperação...");
		}else {
			System.out.println("Você deveria ter estudado mais...Foi reprovado!");
		}
	}
